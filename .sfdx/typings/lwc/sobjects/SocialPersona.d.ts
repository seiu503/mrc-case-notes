...
declare module "@salesforce/schema/SocialPersona.Bio" {
  const Bio:string;
  export default Bio;
}
...
declare module "@salesforce/schema/SocialPersona.Followers" {
  const Followers:number;
  export default Followers;
}
declare module "@salesforce/schema/SocialPersona.Following" {
...
declare module "@salesforce/schema/SocialPersona.ListedCount" {
  const ListedCount:number;
  export default ListedCount;
}
declare module "@salesforce/schema/SocialPersona.MediaProvider" {
...
declare module "@salesforce/schema/SocialPersona.NumberOfFriends" {
  const NumberOfFriends:number;
  export default NumberOfFriends;
}
declare module "@salesforce/schema/SocialPersona.NumberOfTweets" {
  const NumberOfTweets:number;
...
declare module "@salesforce/schema/SocialPersona.ProfileType" {
...
declare module "@salesforce/schema/SocialPersona.R6SourceId" {
