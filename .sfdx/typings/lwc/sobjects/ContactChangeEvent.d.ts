...
declare module "@salesforce/schema/ContactChangeEvent.CanAllowPortalSelfReg" {
  const CanAllowPortalSelfReg:boolean;
  export default CanAllowPortalSelfReg;
}
...
declare module "@salesforce/schema/ContactChangeEvent.HasOptedOutOfFax" {
