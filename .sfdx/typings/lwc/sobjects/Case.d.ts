...
declare module "@salesforce/schema/Case.Entitlement" {
  const Entitlement:any;
  export default Entitlement;
}
declare module "@salesforce/schema/Case.EntitlementId" {
...
declare module "@salesforce/schema/Case.IsStopped" {
...
declare module "@salesforce/schema/Case.MilestoneStatus" {
...
declare module "@salesforce/schema/Case.Product" {
  const Product:any;
  export default Product;
}
declare module "@salesforce/schema/Case.ProductId" {
  const ProductId:any;
...
declare module "@salesforce/schema/Case.SlaExitDate" {
  const SlaExitDate:any;
  export default SlaExitDate;
}
declare module "@salesforce/schema/Case.SlaStartDate" {
...
declare module "@salesforce/schema/Case.StopStartDate" {
